...
class cyclegan(object):
    ...
    def sample_model(self, sample_dir, epoch, idx):
        dataA = glob('./datasets/{}/*.*'.format(self.dataset_dir + '/valiA'))
        dataB = glob('./datasets/{}/*.*'.format(self.dataset_dir + '/valiB'))
        np.random.shuffle(dataA)
        np.random.shuffle(dataB)
    ...
    def test(self, args):
        ...
        if args.which_direction == 'AtoB':
            ...
            sample_files = glob.glob('./datasets/{}/*.*'.format(self.dataset_dir + '/testA'))
        elif args.which_direction == 'BtoA':
            sample_files = glob.glob('./datasets/{}/*.*'.format(self.dataset_dir + '/testB'))
        else:
